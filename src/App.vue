 <template>
    <nav
      class="sticky top-2 z-40 flex justify-between items-center px-4 md:px-6 py-4 bg-gradient-to-r from-emerald-100 via-green-50 to-emerald-100 text-gray-900 mb-4 relative rounded-3xl mx-2 mt-3 border border-emerald-300/60 shadow-[0_12px_30px_rgba(16,185,129,0.18)] backdrop-blur-sm"
    >
      
      <p class="text-2xl flex items-center">
        <router-link to="/" @click="closeMenu">
          <img src="/logo-definitivo.png" alt="Logo" class="h-14 md:h-16 w-auto drop-shadow-md hover:scale-[1.02] transition-transform" />
        </router-link>
      </p>
    ...
    <footer
      class="rounded-3xl shadow-2xl mt-10 mx-4 mb-4 border border-gray-100 overflow-hidden"
    >
      <div
        class="w-full rounded-3xl text-gray-700 bg-gradient-to-r from-white via-emerald-50/40 to-white px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left"
      >
        <div>
